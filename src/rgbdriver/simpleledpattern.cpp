...
uint16_t simpleLedPattern::numColorsRainbow = 100;
 ...
 * @Param patternMode the interpolation mode for the color transistion, see ledPattern::patternModes for options
 */
simpleLedPattern::simpleLedPattern(Adafruit_NeoPixel &strip, uint32_t duration, simpleLedPattern::patternModes patternMode) : ledPattern(strip) {
 ...
 * @Param patternMode the interpolation mode for the color transistion, see ledPattern::patternModes for options
 */
simpleLedPattern::simpleLedPattern(Adafruit_NeoPixel &strip, rgbColor startColor, rgbColor endColor, uint32_t duration, simpleLedPattern::patternModes patternMode) : ledPattern(strip) {
  this->currentDuration = 0;
  this->finalDuration = duration;
  this->startColor = startColor;
  this->currentColor = startColor;
...
void simpleLedPattern::updateStrips() {
  for (std::list<Adafruit_NeoPixel>::iterator it = strips.begin(); it != strips.end(); it++) {
 ...
 */
unsigned long simpleLedPattern::getCurrentDuration() {
 ...
 * @Return unsigned long microtime duration
 */
unsigned long simpleLedPattern::getFinalDuration() {
